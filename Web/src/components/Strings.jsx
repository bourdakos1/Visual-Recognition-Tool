...
var spanish = {
  ...
  optional: '(Opcional)',
  mb2_error: 'Se ha superado el límite de tamaño de imagen (2 MB)',
...
var arabic = {
 ...
 var german = {
  ...
  optional: '(Optional)',
  mb2_error: 'Begrenzung der Bildgröße (2 MB) überschritten',
...
var italian = {
  ...
  mb2_error: 'Superato il limite di dimensione immagine (2MB)',
...
var japanese = {
  ...
  negative_class: '否定',
  optional: '(オプション)',
  mb2_error: 'イメージ・サイズ制限 (2MB) を超えています',
